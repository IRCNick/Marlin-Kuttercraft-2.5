...
//    O-- FRONT --+
//  (0,0)
#define X_PROBE_OFFSET_FROM_NOZZLE  40     // X offset: -left  [of the nozzle] +right
#define Y_PROBE_OFFSET_FROM_NOZZLE  -50     // Y offset: -front [of the nozzle] +behind
...
#define Y_MAX_POS 310 //Activar sensor 310
#define Y_MIN_POS 0
...
#define LEFT_PROBE_BED_POSITION 70    //70
#define RIGHT_PROBE_BED_POSITION 160  //160
#define FRONT_PROBE_BED_POSITION 60   //60
#define BACK_PROBE_BED_POSITION 200   //200
...
#define Z_PROBE_END_SCRIPT "G1 X5 Y5 F4800"
/*****************************************************************************************/
...
#define DEFAULT_MAX_ACCELERATION              {1500, 1500, 1000, 10000, 10000, 10000, 10000}
